"""Encoders used by feature-config-driven household feature construction."""
...
def encode_ordinal_map(
    ...
    """Encode ordered categories using configured numeric values.
...
def encode_numeric_extract(
    ...
    """Convert a category-like series to numeric values.
...
def encode_kids_count(
    ...
    """Encode household kid-count categories as numeric values.
...
def encode_binary_with_unknown(
    ...
    """Encodes a categorical series into positive and unknown indicators.

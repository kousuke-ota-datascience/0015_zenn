...
<!-- Source JSON: docs/10_each_lore/0011_kokkuri_san/0011_20_analysis.json -->
...
**Rationale:** 1884年の伝播がどの具体媒体でなされたかは現在のEvidenceから確定できない。
...
**Rationale:** Scopeである初期三脚型の当時の実流通媒体を直接確定できる資料が不足している。後代の出版記録を当時の流通媒体へ遡及しない。

**Manifestation:** 初期三脚型の流通媒体は不明。
...
**Rationale:** 初期三脚型の成立直後にどのような内部変化が起きたかをScope内で追跡できない。
...
**Rationale:** 質問への回答を得ることを目的とするが、研究資料は真偽を確定せず、実践者側の条件付き信念として扱うのが適切である。

**Manifestation:** 霊を招けば質問への答えが得られるという条件付き信念。

### D07 — I

- Primary: D07.ISU.INFORMATION_VOID (parent: D07.ISU)
- Secondary: -
- Content refs: CNT-001
- Evidence refs: EVD-001

**Rationale:** この実践がなければ残る中心的な不足は、参加者が知りたい質問への答え・未知情報である。
...
**Rationale:** 回答獲得が参加者にとって良い・悪いのどちらかへ固定されるとは初期Scopeから確認できない。
...
**Rationale:** 初期三脚型の終了・解除・危険回避手順を現在のEvidenceから確定できないため、後代の終了作法を遡及しない。
...
**Rationale:** 特権的に真相や追加情報を保持する主体は初期Scopeから確認できないが、その不在を断定するEvidenceもない。

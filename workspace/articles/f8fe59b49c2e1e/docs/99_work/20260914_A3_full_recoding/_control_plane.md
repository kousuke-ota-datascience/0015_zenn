...
| 0112 | 事故物件は一度別人を住ませれば告知義務が消える | 10 | 再レビュー待 | `004` | `b0441eb452661dc4d9457a7e17bd0151c3b07269` | `c213bbd821e368708e49010cacca974d9ba95138` | Review_004指摘対応。D10を制度・法的ルールのtaxonomy gapへ、D13を制度状態自動切替のtaxonomy gapへ再判定。D07/D11の派生Secondaryを除外し、D14=`NEU`、D17=`U`へ保守化。 |
...
- `0060/0081/0089/0091/0101/0112` は00が`完了 / 004`、10はReview_004指摘対応済みで`再レビュー待 / 004`。

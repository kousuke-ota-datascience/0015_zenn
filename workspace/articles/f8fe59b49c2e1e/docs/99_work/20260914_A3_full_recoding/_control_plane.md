...
| 0091 | ベッドの下の男 | 00 | 完了 | `003` | `693ba24ff2f8e04bfc4b3957c8479a6df4607a92` | `afc764c69fb9eb0dfeb50aaced7d20e75a912ec9` | Review_003 Pass。正本変更なし。 |
| 0091 | ベッドの下の男 | 10 | 再レビュー待 | `003` | `9839732bc19dde620ba97f24137ae22f00f080ce` | `97ca6d02fdf9edbeb0861a85152b697b3017e6f2` | Review_003指摘対応。D18を現行作用レイヤー1/0/0へ再判定し2.3.8へ移動、D19を現行taxonomyで再判定、D20/D21を現行階層へ正規化。 |
| 0101 | 海外旅行で臓器を抜かれる | 00 | 完了 | `003` | `2aefa37f5d3343a15d3436823f9001db4a43ff40` | `04db54f073ea0c5f736cce96f69038797dba6315` | Review_003 Pass。正本変更なし。 |
| 0101 | 海外旅行で臓器を抜かれる | 10 | 再レビュー待 | `003` | `e765a04e9d72338b2642b6b4f0587a3ab7525adb` | `9f3a2368fedbdd771fe97fcc6464b7e426e5168b` | Review_003指摘対応。D10を人間加害主体taxonomy gapへ、D17/D04/D19をUへ保守化、D03からBBSを除外。 |
| 0112 | 事故物件は一度別人を住ませれば告知義務が消える | 00 | 再レビュー待 | `003` | `85111550bf6370368616a7483692e3f1ef27786a` | `2748bf99dd88cf594125c54a76084c635e523512` | Review_003指摘対応。0.2.3見出しをtutorial正規名称へ修正。 |
...
- `0112` は00のReview_003指摘対応を完了し `再レビュー待 / 003`（Review_004待）。10はReview_002指摘対応を完了し `再レビュー待 / 002`（Review_003待）とする。

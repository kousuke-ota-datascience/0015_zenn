...
- 再作業中Entry: `0101/0112`
- 再レビュー待Entry: `0060/0081/0089/0091`
...
| 0091 | ベッドの下の男 | 10 | 再レビュー待 | `004` | `97ca6d02fdf9edbeb0861a85152b697b3017e6f2` | `31075c0f7bbbc84cbea0cdd8762b23a0e9586c37` | Review_004指摘対応。D12→D13→D15を体験者→`MANIFEST_ONLY`→真相知識獲得へ再構成し、退避をD17へ分離。D07過剰Secondaryを除外し、D03=`D03.WEB.WEBSITE`、D19=`D19.KIN.SCHOOL_YOUTH`へ現行taxonomy正規化。 |
...
| 0198 | 一人かくれんぼ | 10 | 要修正 | `001` | `ebc2fc8400e97feaa85c5bfecb5be7b39ae821e3` | `37452dff345a613dc030eab5ce3aa296462efdb7` | legacy移行: post-SHAは旧R3 freeze checkpoint（00単独commitではない）。 |
...
- `0060/0081/0089/0091` は00が`完了 / 004`、10はReview_004指摘対応済みで`再レビュー待 / 004`。
- `0101/0112` は00のReview_004 Passを反映済み。10はReview_004修正対応中。

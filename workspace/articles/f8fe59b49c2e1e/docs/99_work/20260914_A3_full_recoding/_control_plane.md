...
- 完了Entry: `0001/0003/0005/0006/0011/0019/0024/0025/0059/0060/0081/0089/0091/0101/0112`
- 再作業中Entry: なし
- 再レビュー待Entry: `0113/0118/0132/0133/0137/0152`
- 要修正Entry: `0157/0158/0169/0178/0179/0180/0181/0188/0198/0225/0250/0275`
- 未着手Entry: 16件
- R5/R6/R7: 未着手
...
| 0081 | ピアスの白い糸 | 10 | 完了 | `006` | `56e3c2af2a40dafe3c339f8262600dfaf9b5e9f4` | `c4f81113bf317f7b38246e5f7a221bf97e18cb73` | Review_006 Pass。正本変更なし。 |
...
| 0091 | ベッドの下の男 | 10 | 完了 | `006` | `31075c0f7bbbc84cbea0cdd8762b23a0e9586c37` | `05c2acbdce1a361262c06c4f4642a16dd2e730b8` | Review_006 Pass。正本変更なし。 |
...
| 0113 | 井の頭公園のボートに乗ると別れる | 00 | 再レビュー待 | `001` | `7acdb0e50cdfedfc984bd0e14cf45b739eeb90f7` | `d85b969917c2a2dff7c49dbda71f68dac9261aeb` | Review_001指摘対応。00からsense-making分析と推測回避規則を除去。 |
| 0113 | 井の頭公園のボートに乗ると別れる | 10 | 再レビュー待 | `001` | `5be227c1b03e2a1aeabcbb255822778c166a0fd0` | `cc4209786c1d6b27978d9d2be692b778507af090` | Review_001指摘対応。D04/D06/D10/D17を保守化、D09単一Status、D19地域限定。 |
| 0118 | 函館山の切れない木 | 00 | 再レビュー待 | `001` | `c17adc9a37c3019e585346f3b8ebbdcdc0346f32` | `8a5614b692c94a785af2a3870b2915a64bb5cde1` | Review_001指摘対応。00をEvidence責務へ戻し、回避反転・流通経路推定を除去。 |
| 0118 | 函館山の切れない木 | 10 | 再レビュー待 | `001` | `63c122601d2fe7bf975f047f5f8b7dd9b1fe2b3a` | `54932c8a44799d927c442eba7b7342b7f739b034` | Review_001指摘対応。D10をコード空欄taxonomy gap化、D17=U、D19地域限定、L3=0。 |
| 0132 | 八幡の藪知らず | 00 | 再レビュー待 | `001` | `39ca6f738f62972ac58b1a4f5ba875143a5cabf9` | `abe0980793d70a106fba8c986059348e343b83d4` | Review_001指摘対応。00の意味形成・変容裁定を除き、由来説差をEvidence記述へ限定。 |
| 0132 | 八幡の藪知らず | 10 | 再レビュー待 | `001` | `9d662fe4e36baa4cfda390b9a4744260467aaba4` | `64b02dbde98e65baa5a1da541a59a873b7e4ebe8` | Review_001指摘対応。D03=I、D04単一I、ACCRETION/CROSS_MEDIA撤回、D17/D18は維持。 |
| 0133 | 将門塚の祟り | 00 | 再レビュー待 | `001` | `058af26a784d134cd6c02e72fac278cb3447f037` | `3eef018dd234c9a32c1fb297a82795687101537d` | Review_001指摘対応。source分類・メタデータをtutorial準拠へ戻し、00の分析先取りを除去。 |
| 0133 | 将門塚の祟り | 10 | 再レビュー待 | `001` | `ae74f13a5c03563f8c556987e17fae78343f3b28` | `fede2e579275f807fe6eef6fae4760008dacfda6` | Review_001指摘対応。D11不作為triggerをtaxonomy gap化、D04/D06/D20保守化、D16=STATIC_RULE、D18=I。 |
| 0137 | 犬鳴村 | 00 | 再レビュー待 | `001` | `5310aca86bb3719fa09703f6693804ad546ef62c` | `58fba945a9cec30986306d56f61a71621f5c280d` | Review_001指摘対応。00の意味形成先取りを除去し、1999年層を要素別Evidenceへ分解。 |
| 0137 | 犬鳴村 | 10 | 再レビュー待 | `001` | `399880d335a6d9cc55b5d9004887e34dcc2a7c32` | `d92f0a6bd53211fb360b0039babb9dc33d31a0e3` | Review_001指摘対応。D15=U、D16=SEQUENTIAL_EPISODE、D17=FLEE_ESCAPE、D20=U。 |
| 0152 | 青木ヶ原樹海で方位磁針が狂う | 00 | 再レビュー待 | `001` | `684c16cb9c01a5fee5babcb8e415ca775fd65d6b` | `a8231c662de9ead82c1cdbc5ef464da61d9daa06` | Review_001指摘対応。00の因果・意味形成・変容裁定を除去し、伝承命題と科学的検証を分離。 |
| 0152 | 青木ヶ原樹海で方位磁針が狂う | 10 | 再レビュー待 | `001` | `ed326e171be81b02f57026b429456142e48998c7` | `d8cd093e4b026f23e644320766da620d07f385cd` | Review_001指摘対応。D08を実受容cueへ変更、D15=MEMORY_COGNITION、D18=I、D20=U。 |
...
- 完了15件は00/10双方の既存最終Review Passを維持する。
- `0113/0118/0132/0133/0137/0152` は `再レビュー待 / 001`。
- `0157/0158/0169/0178/0179/0180/0181/0188/0198/0225/0250/0275` は `要修正 / 001`。
...
- 2026-09-15: 0081_10 / 0091_10 のReview_006返却を反映。両成果物ともPassとして`完了 / 006`へ移行し、両EntryのReview Cycleを完了。
- 2026-09-15: 0113・0118・0132のReview_001指摘対応を完了。00/10の6成果物を`再レビュー待 / 001`へ移行。0118_10はD10を特定自然物因果源のtaxonomy gapとして明示し、0113/0118のD17論理反転を撤回、0132はD03/D04 directnessを保守化。
- 2026-09-15: 0133・0137・0152のReview_001指摘対応を完了。00/10の6成果物を`再レビュー待 / 001`へ移行。0133_10はD11不作為triggerをtaxonomy gapとして明示、0137_10は因果時間をSEQUENTIAL_EPISODEへ再構成、0152_10はD15を方向認知混乱に合わせてMEMORY_COGNITIONへ修正。
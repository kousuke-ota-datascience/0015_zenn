...
`未 → レビュー待 → 完了` または `未 → レビュー待 → 要修正 → 再作業中 → 再レビュー待 → 完了`。00/10のどちらか一方でも未解決ならEntry全体を完了にしない。

# 4. 不一致の扱い

`Scope mismatch / Evidence mismatch / Code-selection mismatch / Status mismatch / Taxonomy gap / Prior coding error / Evidence-Analysis responsibility mismatch / Format mismatch` に分類する。
...
| task | R1〜R4到達 | 未到達 |
|---|---:|---:|
| R1 Evidence / 00監査 | 28 | 21 |
| R2 Version Scope再固定 | 28 | 21 |
| R3 Independent Recode | 28 | 21 |
| R4 Entry QA | 28 | 21 |

- R0: `完了`
- Review Cycle: `0001/0003/0005/0006/0011/0019/0024/0025/0059 完了 / 0060・0081・0089・0091・0101・0112・0113・0118・0132・0133・0137・0152・0157・0158・0169・0178・0179・0180・0181 レビュー待 / 21件 未`
- R5/R6/R7: `未`
...
|0181|コトリバコ|完了|完了|完了|完了|レビュー待|15e4277b3be93a189cc168fa20f62cfb5a63f048|2453520af5a0aa8d99e175f896e4df8f6a160db5|afc96e6404a9fb7ce0e4731052d5da5598bc6c57|00 blob `801be07aac226f47838fe6a0f54a56a3233d667e`、10 blob `4ca7a9c57cc83281fc7cde323421d532df905446`。2005-06-06→06-11早期増補、D21=A4、L3=0。|
...
完了9件は既存の最終Review Passを維持。レビュー待19件は00/10とも未Review・次Review=`Review_001`。
...
- 2026-09-15: 0181 コトリバコをレビュー待へ移行。2005-06-06初回遭遇譚と06-11までの早期体系化を分離し、実在の隠岐騒動と怪談上の製法伝来説を区別。

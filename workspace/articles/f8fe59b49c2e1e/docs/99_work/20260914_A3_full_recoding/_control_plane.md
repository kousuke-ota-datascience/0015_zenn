...
- 再作業中Entry: `0112`
- 再レビュー待Entry: `0060/0081/0089/0091/0101`
...
| 0101 | 海外旅行で臓器を抜かれる | 10 | 再レビュー待 | `004` | `9f3a2368fedbdd771fe97fcc6464b7e426e5168b` | `d7e67837fcd9fdddb583141668a34de953561ff8` | Review_004指摘対応。D07重複Secondaryを除外、D08をScope横断の`FOAF_REPORT`へ一本化、D16 `DELAYED` Secondaryを除外。 |
...
- `0060/0081/0089/0091/0101` は00が`完了 / 004`、10はReview_004指摘対応済みで`再レビュー待 / 004`。
- `0112` は00のReview_004 Passを反映済み。10はReview_004修正対応中。

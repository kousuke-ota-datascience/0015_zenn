...
| 0060 | タクシー幽霊 | 00 | 完了 | `003` | `01bb8e996a50304ba6689d6a01f5bf957fd85042` | `8b8b4be57a11d36e246599ef03f82cca4856af2b` | Review_003 Pass。正本変更なし。 |
| 0060 | タクシー幽霊 | 10 | 再レビュー待 | `003` | `410c9c4bd69a957e0fc0374541444b38ecdfaf73` | `22b8b547d7ba1d5ffcb22d0d7c473575b6957b5b` | Review_003指摘対応。D03をWeb記事へ限定し、1950年代新聞をD03から除外。 |
| 0081 | ピアスの白い糸 | 00 | 完了 | `003` | `410c9c4bd69a957e0fc0374541444b38ecdfaf73` | `1492f1c0b7e70815674df6dd4d4d44d2d6f6e7e5` | Review_003 Pass。正本変更なし。 |
| 0081 | ピアスの白い糸 | 10 | 再レビュー待 | `003` | `89a4a64c08e191d410f938c919e8715130790139` | `7ecf24a85960a6fa42065f928d420766f7ff7be5` | Review_003指摘対応。D03 Secondary BOOKを除外し、雑誌媒体/Iへ限定。 |
| 0089 | 日本だるま／だるま女 | 00 | 完了 | `003` | `89a4a64c08e191d410f938c919e8715130790139` | `f0e3abb21018117629c6b817043cb5861e42cf81` | Review_003 Pass。正本変更なし。 |
| 0089 | 日本だるま／だるま女 | 10 | 再レビュー待 | `003` | `b18a721ca74f8eeb6adcfa42d0e98a287ec960ea` | `46ae27129bced8b8752e00a87677ab191d26449b` | Review_003指摘対応。D10を人間加害主体のtaxonomy gapとして明示、D08=DIRECT_EVENT、D13 Secondaryを除外。 |
| 0091 | ベッドの下の男 | 00 | 再レビュー待 | `002` | `693ba24ff2f8e04bfc4b3957c8479a6df4607a92` | `afc764c69fb9eb0dfeb50aaced7d20e75a912ec9` | Review_002指摘対応。4Gamer 2025の節・段落位置、1.5表、3.1位置列、3.2引用、3.3保留事項を整備。 |
| 0091 | ベッドの下の男 | 10 | 再レビュー待 | `002` | `af25ef37b491cfd16cea48956e4122f8ce4be21d` | `9839732bc19dde620ba97f24137ae22f00f080ce` | Review_002指摘対応。D03をWeb記事へ限定、D08=U。Review_002記載の対象blob SHA誤記をcommit graphと実blobで照合し、対象commit SHAのexact matchを確認。 |
| 0101 | 海外旅行で臓器を抜かれる | 00 | 再レビュー待 | `002` | `2aefa37f5d3343a15d3436823f9001db4a43ff40` | `04db54f073ea0c5f736cce96f69038797dba6315` | Review_002指摘対応。1991年記事内の身体痕跡・医療確認異伝を位置固定し、浴槽・メモの未固定細部を除外。第3章を正規化。 |
| 0101 | 海外旅行で臓器を抜かれる | 10 | 再レビュー待 | `002` | `6e4963fd1fa127d23ffc00e29608460fe80c862f` | `e765a04e9d72338b2642b6b4f0587a3ab7525adb` | Review_002指摘対応。D10=U、D13/D15の推定Secondaryを除外。D08/D17は1991年位置付きEvidenceへ接続。 |
| 0112 | 事故物件は一度別人を住ませれば告知義務が消える | 00 | 再レビュー待 | `002` | `146c6656f54ca7a97fec039ca06783375a5cbdc7` | `85111550bf6370368616a7483692e3f1ef27786a` | Review_002指摘対応。1.4/1.5をtutorial表へ整形し、3.1位置列、3.2引用、3.3保留事項を追加。 |
| 0112 | 事故物件は一度別人を住ませれば告知義務が消える | 10 | 再レビュー待 | `002` | `1aac7714b0bb128823fde7abbe6d11a6c854377e` | `4f8e976cfe1a2fe1e216f61e055d0a865432f74a` | Review_002指摘対応。無効D20 Childと外部制度Anchor混入を除去し、D20=Uへ保守化。 |
...
- `0060/0081/0089` はReview_003で00がPass。10はReview_003指摘対応を完了し、`再レビュー待 / 003`（次Review_004待）とする。
- `0091/0101/0112` はReview_002指摘対応を完了し、00/10とも `再レビュー待 / 002`（Review_003待）とする。

...
|---|---|---|---|---|---|---|---|---|---|
|0001|口裂け女|完了|未|未|未|未|3ee9ff1cc9150cec209020f104e9be3e8f190477|未|過去regressionで差分検出済み。独立再判定後に比較。R1 commit=`c15b7103aeb0ce5d9fd25a7e2f95c54e86032091`。1979-01-26記事所在をNDL実見レファレンスへ修正し、1979年3〜6月の同時代書誌・X Evidenceを補強。|

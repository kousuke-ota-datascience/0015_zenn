...
- `Entry_Type`: 物語・伝説
- `Version_Scope`: 朝里2023のwebムー記事上で、日本の「タクシー幽霊」として再話・解説される共有核を対象とする。すなわち、タクシー運転手が人物を客として乗せ、移動中・到着時にその客が不在となる、または目的地で既に死亡した人物と一致すると判明し、死者・幽霊の乗客として理解される型である。夜・雨・特定墓地・濡れた座席・特定死因は必須条件にしない。1950年代新聞掲載はD01/D02等のHistory Evidenceとしてのみ扱い、当該新聞本文が未実見であるため、現在ScopeのD03/D05/D06へ遡及しない。
...
朝里2023のwebムー記事本文で、客の乗車、消失または故人との一致、幽霊客としての理解を含む複数再話を直接確認できる。1950年代新聞は掲載事実のみを後代資料から間接確認しており、現Version Scopeの具体内容が当該新聞で流通したことは固定できないためD03には含めない。

**この伝承における現れ方**

現在のVersion Scopeに一致する再話群は、Webサイト上の記事として受容者へ提示される。
...
朝里2023は、代表的なタクシー幽霊の再話を物語として紹介しつつ、青山墓地・深泥池等の地域版、1950年代新聞掲載、震災後再話等の由来・流通解説を組み合わせて提示する。

**この伝承における現れ方**

個別の怪談再話と、その類話・地域化・流通史の解説が一つの記事内で組み合わされる。
...
朝里2023はこれらを「タクシー幽霊」という怪談・都市伝説の再話群として整理しており、記事自身が個別事例を検証済み事実として断定する形式ではない。具体的な原体験の真偽は開いたまま提示される。

**この伝承における現れ方**

出来事は怪談・都市伝説として紹介され、個々の乗車体験が実証済み事実かどうかは確定されない。
...
物語内部では、運転手自身が客の不在化、または乗せた人物が故人だったとの確認に直面することが問題化の契機となる。再話されること自体を `WITNESS_REPORT` へ変換しない。

**この伝承における現れ方**

通常営業中の直接経験が、普通の乗客という初期認識を崩す手掛かりとなる。
...
Scope内で安定して確認できる主作用は、死者・幽霊と理解される人物が通常の乗客として運転手の前に現れることである。
...
朝里2023は日本各地に類話があり、青山墓地・深泥池等の地域版が存在することを整理している。このEvidenceは複数地域での流通を支持するが、全国規模の一般社会で共有されたことまでは直接固定しない。

**この伝承における現れ方**

複数の地域で場所に結び付いた類話が確認される。

...
- Primary Child: `D02.PRT.CHAIN_LETTER` — チェーンレター
...
- Primary Child: `D03.PRT.CHAIN_LETTER` — チェーンレター
...
- Primary Child: `D05.RUL.CHAIN_INSTRUCTION` — 連鎖指示
...
- Primary Child: `D10.OBJ.INFORMATION_CONTENT` — 情報内容
...
- Primary Child: `D11.INF.READ_VIEW_MEDIA` — 読む・媒体を見る
...
- Primary Child: `D12.AUD.READER_LISTENER` — 読者・聞き手
- Primary Parent: `D12.AUD` — 受容者・公衆
- Secondary 1 Child: `D12.AUD.NEXT_RECIPIENT` — 次の受信者
- Secondary 1 Parent: `D12.AUD` — 受容者・公衆
- Status: `D` — Direct（典拠に直接明示）
...
- Primary Child: `D13.TRN.PERSON_TRANSFER` — 人から人への伝播
- Primary Parent: `D13.TRN` — 伝播
- Secondary 1 Child: `D13.FAT.CURSE_MISFORTUNE` — 呪詛・不運付与
- Secondary 1 Parent: `D13.FAT` — 運命・吉凶作用
- Status: `D` — Direct（典拠に直接明示）
...
- Primary Child: `D16.TRN.CHAIN_SPREAD` — 連鎖拡散
- Primary Parent: `D16.TRN` — 連鎖・世代
- Secondary: なし
- Status: `D` — Direct（典拠に直接明示）
...
- Primary Child: `D17.CST.TRANSFER_SUBSTITUTE` — 転嫁・身代わり

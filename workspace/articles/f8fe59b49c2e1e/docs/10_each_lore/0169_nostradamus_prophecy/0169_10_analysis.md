...
- Primary Child: `D05.PRP.PREDICTIVE_CLAIM` — 予測命題
...
- Primary Child: `D07.ISU.FUTURE_SOCIAL_CHANGE` — 将来・社会変化
- Primary Parent: `D07.ISU` — 情報・社会的不確実性
- Secondary 1 Child: `D07.DCF.FATE_OMEN` — 運命・予兆
- Secondary 1 Parent: `D07.DCF` — 死・偶然・不運
- Status: `D` — Direct（典拠に直接明示）
...
- Primary Child: `D09.PPR.OMEN_FORECAST` — 予兆・予測
...
- Secondary 1 Child: `D13.FAT.FATE_FIXING` — 運命固定
...
- Primary Child: `D15.COL.PANIC` — 集団パニック
- Primary Parent: `D15.COL` — 集団・社会・制度
- Secondary: なし
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D16.DLY.DEADLINE` — 期限付き

...
- Primary Child: `D07.PSE.HIDDEN_VANISHED_PLACE` — 隠れた・消えた場所
- Primary Parent: `D07.PSE` — 場所・空間・環境
- Secondary 1 Child: `D07.INO.ORGANIZATIONAL_SECRECY` — 組織秘密
- Secondary 1 Parent: `D07.INO` — 制度・組織
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D09.NOR.TABOOIZATION` — 禁忌化
...
- Secondary 1 Child: `D10.HUM.INFORMAL_GROUP` — 非制度的集団・共同体
- Secondary 1 Parent: `D10.HUM` — 人間・社会主体
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D13.SOC.EXCLUDE_STIGMATIZE` — 排除・烙印

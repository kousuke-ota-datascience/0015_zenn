...
- Secondary 1 Child: `D03.WEB.WEBSITE` — Webサイト
- Secondary 1 Parent: `D03.WEB` — オープンWeb・ソーシャル
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D07.PSE.DANGEROUS_PLACE` — 危険・怪異場所
...
- Primary Child: `D08.HIS.HISTORICAL_EVENT` — 歴史事件・戦争・災害
...
- Primary Child: `D09.NOR.GOOD_BAD_VALUATION` — 吉凶・善悪評価
...
- Secondary 1 Child: `D10.SPC.SPECIFIC_PLACE` — 特定場所
- Secondary 1 Parent: `D10.SPC` — 場所・時空
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D11.MAN.CREATE_ALTER_MANIPULATE` — 作る・加工・操作する
- Primary Parent: `D11.MAN` — 操作・儀式
- Secondary 1 Child: `D11.SEN.TACTILE_EXPOSURE` — 触る
- Secondary 1 Parent: `D11.SEN` — 感覚曝露
- Status: `I` — Inferred（定義と証拠から合理的に推定）
...
- Primary Child: `D13.FAT.CURSE_MISFORTUNE` — 呪詛・不運付与
...
- Primary Child: `D15.OPP.LUCK_MISFORTUNE` — 幸運・不運
...
- Primary Child: `D16.REC.TRIGGERED_RECURRENCE` — 条件再発
...
- Secondary 1 Child: `D20.EXP.RELIGIOUS_FOLKLORE` — 宗教・伝承専門家
- Secondary 1 Parent: `D20.EXP` — 専門家・職能者
- Status: `I` — Inferred（定義と証拠から合理的に推定）
